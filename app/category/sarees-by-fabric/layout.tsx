...
const description = `Shop sarees by fabric at ${SITE_NAME} — linen digital prints, Ganga Pattu, cotton & silk. Handcrafted traditional wear with pockets & Flexifit options.`;
